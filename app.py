...
expander.write("Sou Profissional de TI formado como Tecnólogo em Redes de Computadores pela Faculdade Evolução (Fortaleza/CE).")
expander.write("Possuo habilidades com as linguagens: Python, PHP, MySQL, HTML5, CSS3, JavaScript, VBScript, Batch, VBA e sou iniciante em Ciência de Dados.")
...
if know_more == False:
	...
	"""
	Os dados foram coletados do Youtube via Web Scraping através da biblioteca beautifulsoup4, onde foram efetuadas as buscas pelos termos citados e, em cada busca foram 
